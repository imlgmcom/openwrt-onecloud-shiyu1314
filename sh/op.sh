...
git_sparse_clone master https://github.com/kiddin9/openwrt-packages daed
git_sparse_clone master https://github.com/kiddin9/openwrt-packages luci-app-daed
